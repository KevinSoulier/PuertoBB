...
public class BackupService : IBackupService
{
    ...
    public BackupService(CamaraPortuariaDbContext db, ILogger<BackupService> logger)
    {
        _db = db;
        _logger = logger;
    }

    public string NombreSugerido() => $"camara-portuaria-backup-{DateTime.Now:yyyyMMdd-HHmm}.db";
