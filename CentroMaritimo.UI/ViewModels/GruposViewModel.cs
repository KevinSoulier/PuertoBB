...
public class GruposViewModel : PageViewModel
{
    ...
    private void RefrescarMiembros()
    {
        ...
        if (_agenciaSeleccionada != null && _filtroMiembros.Trim() == _agenciaSeleccionada.Nombre)
            return;
    ...
    private async Task EliminarAsync()
    {
        ...
        catch (Exception ex) { MostrarError($"No se pudo eliminar (¿tiene recibos asociados?): {ex.Message}"); }
    }
