...
{
    /// <summary>Recibo con Cliente y Grupo cargados.</summary>
    ...
    /// <summary>Recibo rastreado (con Cliente+Emails) para (empresa, grupo, período), o null. Para crear-o-resumir.</summary>
    ...
    /// <summary>Recibos que matchean el filtro del dashboard (con Cliente/Grupo cargados).</summary>
